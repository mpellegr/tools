{
    ...
    var win = (this instanceof Panel) ? this : new Window("palette", "Replace Fonts (v01)", undefined, {resizeable: true});
    ...
    win.replaceBtn = win.add("button", undefined, "Replace with Varien Regular");
    ...
    win.replaceBtn.onClick = function() {
        ...
        app.endUndoGroup();
        alert("Replaced font '" + selectedFont + "' with 'Varien Regular'.");
    };
