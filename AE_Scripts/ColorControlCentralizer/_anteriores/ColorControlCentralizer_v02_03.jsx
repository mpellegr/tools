/*
ColorControlCentralizer_v02_03.jsx
...
they do not already contain a color animator.
*/
...
(function colorControlCentralizerUI(thisObj) {
    ...
    function runCentralizer(tolerance) {
        ...
        function writeCsvLog() {
            ...
            var file = new File(getScriptFolder().fsName + "/ColorControlCentralizer_v02_03_log_" + getTimestamp() + ".csv");
            file.encoding = "UTF-8";
    ...
    function buildUI(thisObjRef) {
        var win = (thisObjRef instanceof Panel)
            ? thisObjRef
            : new Window("palette", "Color Control Centralizer v02_03", undefined, { resizeable: true });
        ...
        var title = win.add("statictext", undefined, "Color Control Centralizer v02_03");
