/*
ColorControlCentralizer_v02_05.jsx
...
(function colorControlCentralizerUI(thisObj) {
    ...
    function runCentralizer(tolerance, onReviewRowsReady) {
        ...
        function writeCsvLog() {
            ...
            var file = new File(getScriptFolder().fsName + "/ColorControlCentralizer_v02_05_log_" + getTimestamp() + ".csv");
            file.encoding = "UTF-8";
    ...
    function buildUI(thisObjRef) {
        var win = (thisObjRef instanceof Panel)
            ? thisObjRef
            : new Window("palette", "Color Control Centralizer v02_05", undefined, { resizeable: true });
        ...
        var title = win.add("statictext", undefined, "Color Control Centralizer v02_05");
