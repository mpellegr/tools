/*
ColorControlCentralizer_v02_02.jsx
...
Exports a CSV log with applied and omitted color properties.
*/
...
(function colorControlCentralizerUI(thisObj) {
    ...
    function runCentralizer(tolerance) {
        ...
        function writeCsvLog() {
            ...
            var file = new File(getScriptFolder().fsName + "/ColorControlCentralizer_v02_02_log_" + getTimestamp() + ".csv");
            file.encoding = "UTF-8";
    ...
    function buildUI(thisObjRef) {
        var win = (thisObjRef instanceof Panel)
            ? thisObjRef
            : new Window("palette", "Color Control Centralizer v02_02", undefined, { resizeable: true });
        ...
        var title = win.add("statictext", undefined, "Color Control Centralizer v02_02");
